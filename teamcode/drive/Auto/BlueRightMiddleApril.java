...
@Autonomous(name = "BlueRightMiddleApril", group = "BLUE")
public class BlueRightMiddleApril extends LinearOpMode {
    ...
    public void runAutonoumousMode() {
        ...
        switch (propPosition) { //UPDATE THESE POSITIONS
            case LEFT:
                ...
                aprilTagPose = new Pose2d(24.3,80.5, Math.toRadians(90));
                innitPose = new Pose2d(24.3,88.5, Math.toRadians(90));
                purplePixelPose = new Pose2d(25, 3.5, Math.toRadians(-90.0));
            ...
            case CENTER:
                ...
                wallPose2 = new Pose2d(47,-16.5, Math.toRadians(90));
                nitPose = new Pose2d(56,78, Math.toRadians(90));
                aprilTagPose = new Pose2d(31,80.5, Math.toRadians(90));
                innitPose = new Pose2d(28,88.5, Math.toRadians(90));
                purplePixelPose = new Pose2d(49, 3, Math.toRadians(0.0));
                leftPose = new Pose2d(48.5, 3, Math.toRadians(0.0));
                break;
            case RIGHT:
                wallPose1 = new Pose2d(47,-15.5, Math.toRadians(90));
                wallPose2 = new Pose2d(47,-16.5, Math.toRadians(90));
            ...
            switch (propPosition){
                case LEFT:
                    if (detectedTag.pose.x < 0.9) {
                        innitPose = new Pose2d(23.3,90.5, Math.toRadians(90));
                    }
                    if (detectedTag.pose.x > 1.1)    {
                        innitPose = new Pose2d(25.3,90.5, Math.toRadians(90));
                    }
                    break;
                case CENTER:
                    if (detectedTag.pose.x < 0.6) {
                        innitPose = new Pose2d(27,90.5, Math.toRadians(90));
                    }
                    if (detectedTag.pose.x > 0.8)    {
                        innitPose = new Pose2d(29,90.5, Math.toRadians(90));
                    }
                    break;
                case RIGHT:
                    if (detectedTag.pose.x < 0.5) {
                        innitPose = new Pose2d(36,90.2, Math.toRadians(90));
                    }
                    if (detectedTag.pose.x > 0.8)    {
                        innitPose = new Pose2d(38,90.2, Math.toRadians(90));
                    }
                    break;
            }
        }
