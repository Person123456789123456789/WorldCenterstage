...
@Autonomous(name = "RedLeftCloseApril", group = "BLUE")
public class RedLeftCloseApril extends LinearOpMode {
...
CRServo Intake;
    ...
    public void runAutonoumousMode() {
        ...
        Pose2d aprilTagPose= new Pose2d(0, 0, Math.toRadians(0.0));
        ...
        switch (propPosition) { //UPDATE THESE POSITIONS
            case LEFT:
                ...
                aprilTagPose = new Pose2d(40.3,-80.5, Math.toRadians(-90));
            ...
            case CENTER:
                ...
                nitPose = new Pose2d(2,-60, Math.toRadians(-87.5));
                aprilTagPose = new Pose2d(35,-80.5, Math.toRadians(-90));
            ...
            case RIGHT:
                ...
                nitPose = new Pose2d(2, -60,Math.toRadians(-87.5));
                aprilTagPose = new Pose2d(26,-80.5, Math.toRadians(-90));
            ...
            switch (propPosition){
                case LEFT:
                    if (detectedTag.pose.x < 0.6) {
                        innitPose = new Pose2d(39.3,-88.5, Math.toRadians(-90));
                    }
                    if (detectedTag.pose.x > 1)    {
                        innitPose = new Pose2d(41.3,-88.5, Math.toRadians(-90));
                    }
                    break;
                case CENTER:
                    if (detectedTag.pose.x < 0.7) {
                        innitPose = new Pose2d(34,-88.5, Math.toRadians(-90));
                    }
                    if (detectedTag.pose.x > 0.85)    {
                        innitPose = new Pose2d(36,-88.5, Math.toRadians(-90));
                    }
                    break;
                case RIGHT:
                    if (detectedTag.pose.x < 0.5) {
                        innitPose = new Pose2d(25,-89.2, Math.toRadians(-90));
                    }
                    if (detectedTag.pose.x > 0.7)    {
                        innitPose = new Pose2d(27,-89.2, Math.toRadians(-90));
                    }
                    break;
            }
        }
