...
public class GamePropTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new GamePropTest.SamplePipeline_Hue());
    ...
    class SamplePipeline_Hue extends OpenCvPipeline
    {
        ...
        Point Mid_pointA = new Point(600, 350);
        Point Mid_pointB = new Point(670,450);

        Point Left_pointA =  new Point(950, 450);
        Point Left_pointB =  new Point(1030, 550);

        Point Right_pointA = new Point(220, 425);
        Point Right_pointB = new Point(260,500);
        ...
        public Mat processFrame(Mat input)
        {
            ...
            avg1 = (int)Core.mean(Right_Cb).val[0];
            avg2 = (int)Core.mean(mid_Cb).val[0];
            avg3 = (int)Core.mean(Left_Cb).val[0];
